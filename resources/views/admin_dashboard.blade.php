...
<head>
    ...
    <title>Admin Dashboard | K3 STORE</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
</head>
<body class="bg-[#121212] text-white font-sans antialiased">

    <nav class="bg-[#1f1f1f] py-4 px-8 border-b border-gray-800 flex justify-between items-center sticky top-0 z-50">
        ...
        <a href="{{ route('home') }}" class="text-[10px] font-black text-gray-500 hover:text-[#fbbf24] uppercase tracking-widest transition-all">
            <i class="fa fa-external-link-alt mr-1"></i> Lihat Toko
        </a>
    </nav>
        ...
        <div class="max-w-6xl mx-auto">
            <div class="flex justify-between items-end mb-8">
                ...
                <div class="text-right">
                    ...
                    <p class="text-2xl font-black">{{ count($transactions) }}</p>
                </div>
            </div>
    ...
    <footer class="py-10 text-center opacity-20">
        <p class="text-[10px] font-bold tracking-[0.3em] uppercase italic">K3STORE Administrative Terminal v1.0</p>
    </footer>
