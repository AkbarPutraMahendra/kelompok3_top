        ...
        <form action="{{ route('login') }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="admin@k3store.com" class="w-full bg-gray-900 border border-gray-700 pl-9 p-3 rounded-xl text-xs text-white outline-none focus:border-[#fbbf24] transition-all font-semibold" required autofocus>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="password" name="password" placeholder="••••••••" class="w-full bg-gray-900 border border-gray-700 pl-9 p-3 rounded-xl text-xs text-white outline-none focus:border-[#fbbf24] transition-all font-semibold" required>
                </div>
            </div>

            <div class="flex items-center justify-between pt-1">
                <label class="flex items-center gap-2 cursor-pointer select-none">
                    <input type="checkbox" name="remember" class="accent-[#fbbf24] bg-gray-900 border-gray-700 rounded">
