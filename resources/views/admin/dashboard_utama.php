...
<div class="min-h-screen text-gray-100 p-1">
    ...
    <div class="bg-[#1f1f1f] border border-gray-800 rounded-[2.5rem] shadow-2xl p-6 relative overflow-hidden">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            ...
            <div>
                <a href="{{ route('admin.transactions') }}" class="inline-flex items-center gap-2 bg-gray-800 hover:bg-gray-700 text-white text-[10px] font-black uppercase tracking-widest px-4 py-2.5 rounded-xl transition-all shadow-md active:scale-95">
